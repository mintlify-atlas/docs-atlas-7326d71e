...
description: "tally implements 27 Hadolint DL rules and covers 10 more via equivalent BuildKit and tally rules."
---
...
- **27 DL rules** implemented natively by tally
- **10 more** covered by equivalent BuildKit or tally rules
