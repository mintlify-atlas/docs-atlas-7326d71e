...
description: "Keep your Dockerfiles and Containerfiles clean, modern, and consistent. tally uses BuildKit's official parser with 105+ rules and safe auto-fixes."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Rules reference" icon="list-check" href="/rules/overview">
    105+ rules across BuildKit, tally, and Hadolint namespaces.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Broad rule coverage" icon="shield-check">
    22 BuildKit checks + 46 tally rules + 37 Hadolint rules + embedded ShellCheck for shell snippets.
  </Card>
